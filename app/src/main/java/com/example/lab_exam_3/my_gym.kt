...
class my_gym : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        gymAdapter = GymAdapter(database.getAllGyms(),this)

        binding.recyclerViewGyms.layoutManager = LinearLayoutManager(this)
        binding.recyclerViewGyms.adapter = gymAdapter
    }

    override fun onResume() {
        super.onResume()
        gymAdapter.refreshData(database.getAllGyms())
    }
}
